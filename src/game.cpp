...
Game::Game() :
  p1_("Joueur 1", 3, 10, "resources/character_astronaut_v2.png", sf::Vector2u(4,4)),
  p2_("Joueur 2", 3, 10, "resources/astro2.png", sf::Vector2u(4,4)),
  currentMap_(0),
  currentFloor_(0),
...
void Game::buildLevels(){
  ...
  floors_[0].addMap(TileMap("resources/level1.txt"));
  floors_[0].addMap(TileMap("resources/treasureRoom.txt"));
  floors_[0].addMap(TileMap("resources/level3.txt"));
  floors_[0].addMap(TileMap("resources/level4.txt"));
  floors_[0].addMap(TileMap("resources/level5.txt"));
...
void Game::loadBasicMonsters(){
  ...
  if(currentMap_ == 0)
    monsters_.push_back(new Monster("resources/zombie_big.png", sf::Vector2f(100,100), 40, static_cast<unsigned int>(1), 10, sf::Vector2u(3,4), Monster::AI::Tracking));

  else if(currentMap_ == 2){

    monsters_.push_back(new Monster("resources/robot_1.png", sf::Vector2f(100,100), 100, static_cast<unsigned int>(1), 10, sf::Vector2u(4,4), Monster::AI::Tracking));
    monsters_.push_back(new Monster("resources/seigneur_gobelin.png", sf::Vector2f(450,400), 50, static_cast<unsigned int>(1), 15, sf::Vector2u(3,4), Monster::AI::Tracking));
  }

  else if(currentMap_ == 3){

    monsters_.push_back(new Monster("resources/robot_1.png", sf::Vector2f(100,100), 100, static_cast<unsigned int>(1), 10, sf::Vector2u(4,4), Monster::AI::Tracking));
    monsters_.push_back(new Monster("resources/robot_1.png", sf::Vector2f(450,400), 100, static_cast<unsigned int>(1), 10, sf::Vector2u(4,4), Monster::AI::Tracking));
    monsters_.push_back(new Monster("resources/robot_1.png", sf::Vector2f(300,300), 100, static_cast<unsigned int>(1), 10, sf::Vector2u(4,4), Monster::AI::Tracking));
  }

  else if(currentMap_ == 4){

    monsters_.push_back(new Monster("resources/robot_lunaire.png", sf::Vector2f(100,50), 150, static_cast<unsigned int>(1), 15, sf::Vector2u(3,4), Monster::AI::Tracking));
    monsters_.push_back(new Monster("resources/robot_lunaire.png", sf::Vector2f(200,50), 150, static_cast<unsigned int>(1), 15, sf::Vector2u(3,4), Monster::AI::Tracking));
    monsters_.push_back(new Monster("resources/robot_lunaire.png", sf::Vector2f(300,50), 150, static_cast<unsigned int>(1), 15, sf::Vector2u(3,4), Monster::AI::Tracking));
    monsters_.push_back(new Monster("resources/robot_lunaire.png", sf::Vector2f(400,50), 150, static_cast<unsigned int>(1), 15, sf::Vector2u(3,4), Monster::AI::Tracking));
  }
}
...
void Game::startMenu(){
  ...
  if(!font.loadFromFile("resources/akashi.ttf"))
...
void Game::start(){
  ...
  sf::Music theme;
  if(!theme.openFromFile("resources/roblike_theme.wav")){
